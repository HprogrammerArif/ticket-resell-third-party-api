...
export default defineConfig({
  ...
  rules: {
    ...
    'typescript/no-explicit-any': 'warn', // Discourage explicit `any`; use `unknown` and narrow instead
    'typescript/no-unsafe-type-assertion': 'off', // Allow type assertions for JSON parsing and API responses
